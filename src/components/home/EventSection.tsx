...
export function EventSection() {
  return (
    <section className="border-b border-r-line bg-r-bg py-6 md:py-8">
      <div className="container-brand">
        <div className="flex flex-col overflow-hidden rounded-[var(--radius-brand-card)] border border-r-line bg-r-panel/50 md:flex-row md:items-stretch">
          <div className="relative h-56 w-full shrink-0 sm:h-72 md:h-auto md:w-[28rem]">
            <Image
          ...
          <div className="flex flex-1 flex-col gap-8 p-8 md:min-h-[22rem] md:flex-row md:items-center md:justify-between md:p-14">
